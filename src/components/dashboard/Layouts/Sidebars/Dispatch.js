                    ...
                    <div className="mt-20 overflow-auto">
                        ...
                        >
                            <div className="flex" onClick={e => e.stopPropagation()}>
                                ...
                                <div className="flex items-center cursor-pointer" onClick={() => {setServiceDrop(!serviceDrop);setOrderDrop(false);}}>
                        ...
                        >
                            <div className="flex" onClick={e => e.stopPropagation()}>
                                ...
                                <div className="flex items-center cursor-pointer" onClick={() => {setOrderDrop(!orderDrop);setServiceDrop(false)}}>
