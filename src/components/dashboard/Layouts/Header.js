        ...
        <div className="fixed w-full z-50  bg-white">
            <div className="flex w-full justify-between lg:head-grid">
                <div className="bg-white py-1  text-center">
                    <Link to="/"><img src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1671791124/5mlog/new-logo_d5wzz4.png" alt="boglogo" className="w-16 xl:w-20 lg:h-20 h-16 mx-auto" /></Link>
                </div>
