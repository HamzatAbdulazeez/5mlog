        ...
        >
            ...
            <SwiperSlide>
                <div className='w-full flex items-center font-primary'>
                    ...
                    <div className='w-5/12'>
                        <img src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1670473627/5mlog/Group_237785_rssvaq.png" alt="hero1" className='w-11/12' />
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide>
                <div className='w-full flex items-center font-primary'>
                    <div className='w-6/12 relative -top-10'>
            ...
            <SwiperSlide>
                <div className='w-full flex items-center font-primary'>
                    <div className='w-6/12 relative -top-2'>
